				...
				<div data-id="100002" class="prop-attrs">
					<div class="attr">
						...
						<div class="a-values">
							<div class="v-fold">
								<ul class="f-list">
									<li><a href="javascript:filter('price','0-999')">0-999</a></li>
									<li><a href="javascript:filter('price','1000-1999')">1000-1999</a></li>
									<li><a href="javascript:filter('price','2000-2999')">2000-2999</a></li>
									<li><a href="javascript:filter('price','3000-3999')">3000-3999</a></li>
									<li><a href="javascript:filter('price','4000-4999')">4000-4999</a></li>
									<li><a href="javascript:filter('price','5000-*')">5000以上</a></li>
								</ul>
							</div>
						</div>
					</div>
