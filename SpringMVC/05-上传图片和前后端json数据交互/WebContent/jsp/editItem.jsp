...
<body> 
	...
	<form id="itemForm"	action="${pageContext.request.contextPath }/editByVo" method="post" enctype="multipart/form-data">
		<input type="hidden" name="items.id" value="${item.id }" /> 修改商品信息QueryVo.items：
